...
#### Q11
Run the tests available under `BaseBankTest`.
...
#### Q21
In `Server`, implement a handler for doing a transfer in the banking system.
...
#### Q22
Test that your implementation is properly working with the help of the `curl` program.
...
#### Q31
Execute the banking application as a container on your local machine.
...
#### Q32
Create a cluster in Google Cloud Platform to host the containers.
...
#### Q34
Export the Docker image in DockerHub.
...
#### Q41
To have an overview of ISPN, read the introduction (Section 1) of the [documentation](http://infinispan.org/docs/stable/user_guide/user_guide.html).
...
#### Q42
In GCP, create a bucket in the Storage menu.
...
#### Q43
Create a variable `accounts` in `DistributedBank` backed by an Infinispan cache.
...
We can observe that the total balance is not 0 as it should be. This reminds us of a _fuzzy read anomanly_, we observe a partial state at the end.
